...
<html lang="en">
    <head>
        ...
        <!-- Favicon -->
        <link rel="icon" href="{{ url('frontend/images/fav.png') }}" type="image/x-icon">
        <!-- fonts -->
        ...
        <link rel="stylesheet" href="{{ asset('frontend/css/sitemap.css') }}">
    </head>
<body>
                            ...
                            <ul class="dropdown-menu dropdown-menu2 shadow" id="featureMenu">
                                ...
                                @foreach($categories as $category)
                                    <li id="structuralDropdown" class="dropdown-item dropdown mt-1 test">
                                        <a id="structuralLink" class="dropdown-item customnavlink" href="{{ url('/category/'.$category->id) }}" role="button" aria-haspopup="true" aria-expanded="false">
                                            {{ $category->name }} <i class="fa-solid fa-caret-right"></i>
                                        </a>
            ...
            <ul class="mobile-menu-nav">
                ...
                <li class="mobile-menu-item mobile-menu-dropdown">
                    ...
                    <ul class="mobile-menu-submenu">
                        ...
                        @foreach($categories as $category)
                        <li class="mobile-menu-item mobile-menu-dropdown">
                            <a class="mobile-menu-link" href="{{ url('/category/'.$category->id) }}">{{ $category->name }}
                                <span class="dropdown-icon">&#x25BC;</span>
                            </a>
                            <ul class="mobile-menu-submenu">
    ...
    <section class="sitemap sectionDeviderforDesktopTopPadding sectionDeviderforDesktopBottomPadding">
        <div class="container custom-container">
            <ul class="sitemap-list">
                <li class="custom-padding"><a href="{{ url('/') }}">Home</a></li>
                <li class="custom-padding"><a href="{{ '/about' }}">About Us</a></li>
                <li>
                    ...
                    <ul>
                        ...
                        ?>
                            @foreach($categories as $category)
                        <li class="custom-padding list-unstyled"><a href="{{ url('/category/'.$category->id) }}">{{ $category->name }}</a>
                            <ul>
                                @foreach($category->products as $product)
                                    <li class="list-unstyled"><a href="{{ url('/product/'.$product->id) }}">{{ $product->title }}</a></li>
                                @endforeach
                            </ul>
                        </li>
                            @endforeach
                ...
                <li class="custom-padding"><a href="{{ '/contact' }}">Contact Us</a></li>
            </ul>
        </div>
    </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12 footerContactcustomPadding customwidthfofooter customwidthfofooter2 emailPhoneforDesktop footernewclass4">
                            ...
                            <ul class="list-unstyled">
                                <li class="text-white footerNewMargin">Email :<a href="mailto:sales@tabsteels.com"> sales@tabsteels.com</a></li>
                                <li class="text-white">Phone : <a href="tel:+6598162261">(+65) 98162261</a></li>
                            </ul>
                        </div>
